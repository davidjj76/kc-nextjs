...
export default function CompleteCourse({ courseId }: { courseId: string }) {
  ...
  return (
    <button
      type="reset"
      className="bg-secondary focus-visible:outline-secondary rounded-md px-3 py-2 text-sm font-semibold text-white hover:bg-sky-600 focus-visible:outline-2 focus-visible:outline-offset-2"
      onClick={() => {
